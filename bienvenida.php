			...
			<div class="carousel-inner">
			    <div class="item active">
                    ...
                    <div class="header-text hidden-xs">
                        <div class="col-md-12 text-center">
                            <h2>
                            	<span>Bienvenido a <strong>Society Rock</strong></span>
                            </h2>
                            <br>
                            <h3>
                            	<span>La plataforma de musicos under mas grande de Latinoamerica.</span>
                            </h3>
                            <br>
                            <div class="">
			    ...
			    <div class="item">
                    ...
                    <div class="header-text hidden-xs">
                        <div class="col-md-12 text-center">
                            <h2>
                                <span>Bienvenido a SocietyRock</span>
                            </h2>
                            <br>
                            <h3>
                            	<span>La plataforma de musicos under mas grande de Latinoamerica.</span>
