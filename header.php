<div class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="index.php">Society - Rock</a>
        </div>
        <center>
            <div class="navbar-collapse collapse" id="navbar-main">
                ...
                <form class="navbar-form navbar-left" role="search">
                    <div class="form-group">
                        <input type="text" class="form-control" placeholder="Busca a tu banda">
                    </div>
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu" role="menu">
            <li><a href="#">Blog</a></li>
            <li><a href="#">Compra y vende</a></li>
            <li><a href="#">Registra tu Instrumento</a></li>
            <li class="divider"></li>
