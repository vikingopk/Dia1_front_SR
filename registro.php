...
<div class="row">
    <div class="col-xs-12 col-sm-8 col-md-6 col-sm-offset-2 col-md-offset-3">
		<form role="form">
			<h2>Society Rock <small>Es gratis y lo sera por siempre :)</small></h2>
			<hr class="colorgraph">
			<br/>
			<div class="row">
			...
			<div class="form-group">
				<input type="text" name="display_name" id="display_name" class="form-control input-lg" placeholder="Nick" tabindex="3">
			</div>
			<div class="form-group">
			...
			<div class="row">
				...
				<div class="col-xs-12 col-sm-6 col-md-6">
					<div class="form-group">
						<input type="password" name="password_confirmation" id="password_confirmation" class="form-control input-lg" placeholder="Confirma Password" tabindex="6">
					</div>
				</div>
			</div>
			<div class="row">
				...
				<div class="col-xs-8 col-sm-9 col-md-9">
					 Clickeando <strong class="label label-primary">Registrar</strong>, aceptas los <a href="#" data-toggle="modal" data-target="#t_and_c_m">Terminos y Condiciones</a> de este sitio, incluido el uso de Cookie.
				</div>
			</div>
